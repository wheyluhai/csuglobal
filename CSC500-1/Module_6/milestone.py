...
my_cart = shopping_cart("John Doe", date.today().strftime("%B %d, %Y"))
...
while not checkout:
    ...
    match user_selection:
        ...
        case "r":
            ...
            item_to_remove = input("\nWhich item do you want to remove? (Enter Item name): ")
        ...
        case "c":
            ...
            modified_item.item_price = float(input("Enter the desired item price:\n"))
            modified_item.item_quantity = int(input("Enter the desired item quantity:\n"))
            modified_item.item_description = input("Enter the desired item description:\n")
